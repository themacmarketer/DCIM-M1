...
return stack;})(stacks.stacks_in_1216_4);
stacks.stacks_in_285 = {};
stacks.stacks_in_285 = (function(stack) {document.addEventListener("DOMContentLoaded", function() {ML_RMenu.useTouch('#stacks_in_285');});

return stack;})(stacks.stacks_in_285);
stacks.stacks_in_891 = {};
stacks.stacks_in_891 = (function(stack) {document.addEventListener( 'DOMContentLoaded', function () {
	var element = document.getElementById("splide-stacks_in_891");
	if(typeof(element) != 'undefined' && element != null){
	var syncContent1 =new Splide( '#splide-stacks_in_891',{
		type: 'slide',
		direction: 'ltr',
		perPage: 1,
		gap: 0,
...
window.nav1(); syncContent1.sync( window.syncNav1 ).mount();
}});

return stack;})(stacks.stacks_in_891);
stacks.stacks_in_966 = {};
stacks.stacks_in_966 = (function(stack) {window.nav1 = function () {
	var element = document.getElementById("splide-stacks_in_966");
	if(typeof(element) != 'undefined' && element != null){
	window.syncNav1 =new Splide( '#splide-stacks_in_966',{
		type: 'slide',
		direction: 'ltr',
		perPage: 3,
		gap: 10,
...
stacks.stacks_in_854 = (function(stack) {document.addEventListener( 'DOMContentLoaded', function () {
	var element = document.getElementById("splide-stacks_in_854");
	if(typeof(element) != 'undefined' && element != null){
	window.splider0 =new Splide( '#splide-stacks_in_854',{
		type: 'loop',
		direction: 'ltr',
		perPage: 3,
		gap: 20,
...
stacks.stacks_in_31 = {};
stacks.stacks_in_31 = (function(stack) {document.addEventListener( 'DOMContentLoaded', function () {
	var element = document.getElementById("splide-stacks_in_31");
	if(typeof(element) != 'undefined' && element != null){
	window.splider0 =new Splide( '#splide-stacks_in_31',{
		type: 'loop',
		direction: 'ttb',
		perPage: 3,
		gap: 0,
